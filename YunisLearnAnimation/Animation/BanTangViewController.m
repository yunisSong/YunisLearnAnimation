...
#import "BanTangViewController.h"
#import <QuartzCore/QuartzCore.h>
#import <CoreText/CoreText.h>
@interface BanTangViewController ()
{
...
@implementation BanTangViewController
...
- (void) setupTextLayer
{
    ...
    CTFontRef font = CTFontCreateWithName(CFSTR("Helvetica-Oblique"), 32.0f, NULL);

//    CTFontRef font = CTFontCreateWithName(CFSTR("HelveticaNeue-UltraLight"), 32.0f, NULL);
    NSDictionary *attrs = [NSDictionary dictionaryWithObjectsAndKeys:
                           (__bridge id)font, kCTFontAttributeName,
                           nil];
    NSAttributedString *attrString = [[NSAttributedString alloc] initWithString:@"Yunis And Yunlia"
                                                                     attributes:attrs];
